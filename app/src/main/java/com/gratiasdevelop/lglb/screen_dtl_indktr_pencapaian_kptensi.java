...
public class screen_dtl_indktr_pencapaian_kptensi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_screen_dtl_indktr_pencapaian_kptensi);
        ...
        txtV_BTN_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent screenMenuUtama = new Intent(screen_dtl_indktr_pencapaian_kptensi.this,screen_menu_utama.class);
