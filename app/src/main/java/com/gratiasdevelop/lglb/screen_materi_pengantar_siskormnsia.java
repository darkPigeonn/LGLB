...
public class screen_materi_pengantar_siskormnsia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_screen_materi_pengantar_siskormnsia);
        ...
        txtV_BTN_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent screenMenuUtama = new Intent(screen_materi_pengantar_siskormnsia.this,screen_menu_utama.class);
