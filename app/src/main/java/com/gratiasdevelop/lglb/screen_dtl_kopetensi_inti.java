...
public class screen_dtl_kopetensi_inti extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_screen_dtl_kopetensi_inti);
        ...
        txtV_BTN_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent screenMenuUtama = new Intent(screen_dtl_kopetensi_inti.this,screen_menu_utama.class);
